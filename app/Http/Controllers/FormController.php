...
class FormController extends Controller
{
    ...
    public function formeditdiri(Request $request)
    {
        ...
        $exprofile->Akun_Facebook = $request->input('facebook');
        $exprofile->Akun_Twitter = $request->input('twitter');
        $exprofile->Akun_Instagram = $request->input('instagram');
        $exprofile->Akun_LinkedIn = $request->input('linkedin');
