                ...
                <div class="col-lg-12">
                  <div class="box-primary">
                    ...
                    <div class="box-body">
                      <div class="row">
                        <div class="col-lg-12" >
                          <form action="{{route('filter.unit')}}" class="form-inline pull-right" method="post" enctype="multipart/form-data">
                          {{ csrf_field() }}
                            <div class="row"> 
                              <div class="col-lg-8">
                                <div class="form-group">
                                  <select class="form-control select2" style="width: 100%;" name="unit">
                                      ...
                                      @foreach($chart_all_divisi as $div)
                                        <option value="{{$div->list_divisi}}">{{$div->list_divisi}}</option>
                                      @endforeach
                                    </select>
                                </div>
                              </div>
