            ...
            <div class="box-body">
                ...
                <div class="col-lg-12">
                  <div class="box-primary">
                    <div class="box-header">
                      <div class="box-title">Divisi</div>
                    </div>
                    <div class="box-body">
                      <div class="chart">
                        <canvas id="divisiChart" height="300"></canvas>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="box-primary">
                    <div class="box-header">
                      <div class="box-title">Satuan</div>
                    </div>
                    <div class="box-body">
                      <div class="chart">
                        <canvas id="satuanChart" height="150"></canvas>
                      </div>
                    </div>
                  </div>
                </div>
...
var ctx2 = document.getElementById("divisiChart").getContext('2d');
...
var ctx3 = document.getElementById("satuanChart").getContext('2d');
...
var ctx4 = document.getElementById("jenjangChart").getContext('2d');
